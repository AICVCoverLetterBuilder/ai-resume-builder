...
const SPANISH_EXPERIENCE_GUARANTEE_GROUNDING_308 =
  'spanish-experience-guarantee-grounding-308-v1';
const SPANISH_EXPERIENCE_REPAIR_GROUNDING_309 =
  'spanish-experience-repair-grounding-309-v1';
const EXPERIENCE_REPAIR_LINEAGE_309 = 'experience-repair-lineage-309-v1';
const SPANISH_EXPERIENCE_PREDICATE_GROUNDING_310 =
  'spanish-experience-predicate-grounding-310-v1';
const EXPERIENCE_PREDICATE_REPAIR_LINEAGE_310 =
  'experience-predicate-repair-lineage-310-v1';
const EXPERIENCE_VISIBLE_NOOP_AUTHORITY_311 =
  'experience-visible-noop-authority-311-v1';
const SPANISH_EXPERIENCE_COMPLIANCE_GROUNDING_311 =
  'spanish-experience-compliance-grounding-311-v1';
const EXPERIENCE_PREDICATE_PHASE_DIAGNOSTICS_311 =
  'experience-predicate-phase-diagnostics-311-v1';
const EXPERIENCE_VISIBLE_SNAPSHOT_WIRING_312 =
  'experience-visible-snapshot-wiring-312-v1';
const EXPERIENCE_SEMANTIC_NOOP_FINAL_GATE_312 =
  'experience-semantic-noop-final-gate-312-v1';
const EXPERIENCE_FACT_AUTHORITY_CONSISTENCY_312 =
  'experience-fact-authority-consistency-312-v1';
const EXPERIENCE_CANONICAL_FINALIZATION_313 =
  'experience-canonical-finalization-313-v1';
const SPANISH_EXPERIENCE_SURFACE_FORM_GATE_313 =
  'spanish-experience-surface-form-gate-313-v1';
const EXPERIENCE_EVIDENCE_BASED_IMPROVEMENT_313 =
  'experience-evidence-based-improvement-313-v1';
const EXPERIENCE_SINGLE_DECISION_APPLY_GATE_313 =
  'experience-single-decision-apply-gate-313-v1';
const SPANISH_EXPERIENCE_MORPHOLOGY_314 =
  'spanish-experience-morphology-314-v1';
const SPANISH_EXPERIENCE_TENSE_EVIDENCE_314 =
  'spanish-experience-tense-evidence-314-v1';
const EXPERIENCE_NONVACUOUS_PREDICATE_GATE_314 =
  'experience-nonvacuous-predicate-gate-314-v1';
const EXPERIENCE_SOURCE_DEFECT_FIRST_DECISION_315 =
  'experience-source-defect-first-decision-315-v1';
const SPANISH_EXPERIENCE_PROVIDER_NOOP_TENSE_RECOVERY_315 =
  'spanish-experience-provider-noop-tense-recovery-315-v1';
const SPANISH_EXPERIENCE_FINAL_TENSE_ACCEPTANCE_315 =
  'spanish-experience-final-tense-acceptance-315-v1';
const EXPERIENCE_TENSE_DECISION_DIAGNOSTICS_315 =
  'experience-tense-decision-diagnostics-315-v1';
const EXPERIENCE_SINGLE_CANONICAL_FINALIZER_316 =
  'experience-single-canonical-finalizer-316-v1';
const SPANISH_EXPERIENCE_SEMANTIC_DELTA_GROUNDING_316 =
  'spanish-experience-semantic-delta-grounding-316-v1';
const SPANISH_EXPERIENCE_VALID_SOURCE_NOOP_316 =
  'spanish-experience-valid-source-noop-316-v1';
const EXPERIENCE_FINAL_DECISION_TRUTH_316 =
  'experience-final-decision-truth-316-v1';
...
for (const marker of [
  ...
  SPANISH_EXPERIENCE_GUARANTEE_GROUNDING_308,
  SPANISH_EXPERIENCE_REPAIR_GROUNDING_309,
  EXPERIENCE_REPAIR_LINEAGE_309,
  SPANISH_EXPERIENCE_PREDICATE_GROUNDING_310,
  EXPERIENCE_PREDICATE_REPAIR_LINEAGE_310,
  EXPERIENCE_VISIBLE_NOOP_AUTHORITY_311,
  SPANISH_EXPERIENCE_COMPLIANCE_GROUNDING_311,
  EXPERIENCE_PREDICATE_PHASE_DIAGNOSTICS_311,
  EXPERIENCE_VISIBLE_SNAPSHOT_WIRING_312,
  EXPERIENCE_SEMANTIC_NOOP_FINAL_GATE_312,
  EXPERIENCE_FACT_AUTHORITY_CONSISTENCY_312,
  EXPERIENCE_CANONICAL_FINALIZATION_313,
  SPANISH_EXPERIENCE_SURFACE_FORM_GATE_313,
  EXPERIENCE_EVIDENCE_BASED_IMPROVEMENT_313,
  EXPERIENCE_SINGLE_DECISION_APPLY_GATE_313,
  SPANISH_EXPERIENCE_MORPHOLOGY_314,
  SPANISH_EXPERIENCE_TENSE_EVIDENCE_314,
  EXPERIENCE_NONVACUOUS_PREDICATE_GATE_314,
  EXPERIENCE_SOURCE_DEFECT_FIRST_DECISION_315,
  SPANISH_EXPERIENCE_PROVIDER_NOOP_TENSE_RECOVERY_315,
  SPANISH_EXPERIENCE_FINAL_TENSE_ACCEPTANCE_315,
  EXPERIENCE_TENSE_DECISION_DIAGNOSTICS_315,
  EXPERIENCE_SINGLE_CANONICAL_FINALIZER_316,
  SPANISH_EXPERIENCE_SEMANTIC_DELTA_GROUNDING_316,
  SPANISH_EXPERIENCE_VALID_SOURCE_NOOP_316,
  EXPERIENCE_FINAL_DECISION_TRUTH_316,
