...
describe('Creative Bold export routing and rendering', () => {
  ...
  test('Creative Bold is included in styled html2canvas clone and image paths', () => {
    ...
    expect(src).toContain("type StyledPdfTemplateId = 'modern-minimal' | 'clean-simple' | 'professional-classic' | 'creative-bold'");
    ...
    expect(src).toContain("captureTemplateId === 'clean-simple' || captureTemplateId === 'professional-classic' || captureTemplateId === 'creative-bold'");
  });
