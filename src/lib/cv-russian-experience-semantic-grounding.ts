...
const DEVELOP_CONCEPTS = /(?:\bdevelop\w*\b.{0,32}\b(?:visual\s+)?design\s+concepts?\b|\bconcepts?\b.{0,32}\bdesign\b|разрабатыва\w*.{0,32}концепц\w*.{0,32}дизайн\w*|विज़ुअल\s+डिज़ाइन\s+अवधारणाएँ.{0,32}(?:विकसित|बनाती|तैयार)|दृश्य\s+डिज़ाइन\s+अवधारणाएँ.{0,32}(?:विकसित|बनाती|तैयार)|ビジュアル.{0,20}コンセプト.{0,24}(?:開発|作成)|مفاهيم.{0,32}تصميم.{0,32}(?:طو|تطوير)|vizueln\w*.{0,24}koncept\w*.{0,24}dizajn)/iu;
