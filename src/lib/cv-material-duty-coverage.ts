...
const DUTY_RULES: DutyRule[] = [
  ...
  localized:
      /(?:(?:prover\w*|provjer\w*|pregled\w*|check\w*|verif\w*|जाँच|जांच|जाच|確認|تتحقق|تحقّقت|يتحقق|فحص|проверя|入荷|prüf\w*|kontroll\w*|überprüf\w*).{0,48}(?:rob\w*|goods?|माल|वस्तु|товар|بضائع|واردة|商品|zaprimljen\w*|skladišt\w*|сопроводительн|関連書類|添付書類|Waren|Wareneingang|eingehend\w*\s+Waren|Lieferungen)|(?:rob\w*|goods?|माल|वस्तु|товар|بضائع|واردة|商品|zaprimljen\w*|skladišt\w*|сопроводительн|関連書類|添付書類|Waren|Wareneingang).{0,48}(?:prover\w*|provjer\w*|pregled\w*|check\w*|verif\w*|जाँच|जांच|जाच|確認|تتحقق|تحقّقت|فحص|проверя|prüf\w*|kontroll\w*|überprüf\w*)|(?:pristigl\w*|incoming|inbound|आने\s*वाल|واردة|поступающ|入荷|zaprimljen\w*|eingehend).{0,40}(?:rob\w*|goods?|माल|بضائع|товар|商品|Waren)|(?:prateć\w*|popratn\w*|accompany\w*|संबंधित|مرفق|сопроводительн|関連書類|添付書類|zugehörig|dazugehörig|begleitend).{0,40}(?:dokument|document|दस्तावे|وثائق|документ|Unterlagen|Dokumente|Aufzeichnungen|Belege))/iu,
  },
  {
